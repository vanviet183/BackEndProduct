...
public class VerifyTokenController {
    ...
    @ApiOperation(value = "Verification Sign Up Account")
    ...
    @ApiOperation(value = "Verification Sign Up Email Notification")
    ...
    @ApiOperation(value = "Verification Resend Verification Token")
