...
public class UrlConstant {
  ...
  public static class Product {
    ...
    public static final String DATA_PRODUCT_GET_RATE = PRE_FIX + "/rate/{idProduct}";
  ...
  public static class ProductProperties {
    ...
    private static final String PRE_FIX = "/product-properties";
    public static final String DATA_PRODUCT_PROPERTIES = PRE_FIX;
    public static final String DATA_PRODUCT_PROPERTIES_ID = PRE_FIX + "/{id}";
    public static final String DATA_PRODUCT_PROPERTIES_FOR_PRODUCT = PRE_FIX + "/create" + "/{idProduct}";
  }
